...
class NewsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Nieuws::create(['title' => 'Wegenwerken centrum', 'content' => 'Vanaf juni starten wegenwerken in het centrum van Wemmel. Houd rekening met verkeershinder.', 'category' => 'Mobiliteit', 'published_at' => now()]);
        Nieuws::create(['title' => 'Zomerkampen 2026', 'content' => 'Inschrijvingen voor de zomerkampen 2026 zijn geopend. Schrijf uw kind nu in!', 'category' => 'Jeugd', 'published_at' => now()]);
    }
}
